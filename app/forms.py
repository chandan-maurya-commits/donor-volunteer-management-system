...
class UserForm(UserCreationForm):
    ...
    password2 = forms.CharField(label='Confrm Password (again)', widget=forms.PasswordInput(attrs={'class': 'form-control','placeholder':'Enter Password Again'}))
    class Meta:
        model=User
...
class MyPasswordChangeForm(PasswordChangeForm):
    old_password = forms.CharField(label="Old Password",strip=False, widget=forms.PasswordInput(attrs={'autocomplete':'current-password','autofocus':True,'class':'form-control','placeholder':'Old Pssword'}))
...
DONATION_CHOICES=(
    ...
    ('Vessel Donattion','Vessel Donation'),
    ('Other','Other'),
)
